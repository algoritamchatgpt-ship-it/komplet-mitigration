...
public partial class AnSaldoViewModel : ObservableObject
{
    ...
    public AnSaldoViewModel(string folderPath,
        string dbfName = "ansaldo.dbf",
        string naslov = "SALDO ANALITIKE")
    {
