...
public partial class AnBrutoViewModel : ObservableObject
{
    ...
    public AnBrutoViewModel(string folderPath,
        string dbfName = "anbruto.dbf",
        string naslov = "BRUTO BILANS ANALITIKE")
    {
    ...
    private void PrimenjiFilter()
    {
        ...
        if (!string.IsNullOrEmpty(partner))
            filtrirane = filtrirane.Where(s =>
                ...
                (s.TryGetValue("NPARTNER", out var np) && np?.ToString()?.ToLowerInvariant().Contains(partner) == true));
