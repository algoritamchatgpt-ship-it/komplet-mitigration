...
public partial class AnIosViewModel : ObservableObject
{
    ...
    public AnIosViewModel(string folderPath,
        string dbfName = "anios.dbf",
        string naslov = "IOS — IZJAVA O STANJU")
    {
    ...
    [RelayCommand]
    private void OcistiFilter() => FilterPartner = "";
