...
public partial class NaltrnaltraziViewModel : ObservableObject
{
    ...
    public NaltrnaltraziViewModel(ObservableCollection<NalmtrRow> redovi, Action<NalmtrRow> pozicioniraj)
    {
        _redovi = redovi;
