...
public partial class NalbrojTraziViewModel : ObservableObject
{
    private readonly ObservableCollection<NalbrojRow> _redovi;
    private readonly Action<NalbrojRow> _pozicioniraj;

    [ObservableProperty] private string _traziVrednost = string.Empty;

    public NalbrojTraziViewModel(ObservableCollection<NalbrojRow> redovi, Action<NalbrojRow> pozicioniraj)
    {
        _redovi = redovi;
